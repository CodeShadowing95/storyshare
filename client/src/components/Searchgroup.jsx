  ...
  return (
    <div className="flex items-center w-[300px]">
      <form className="relative w-full">
        ...
        <input type="text" id="voice-search" className="outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 pe-8 p-2.5" placeholder="Rechercher un groupe..." required />
